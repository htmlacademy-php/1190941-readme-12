...
<!--                        <a class="post__author-link" href="#" title="Автор">-->
<!--                            <div class="post__avatar-wrapper">-->
<!--                                <img class="post__author-avatar" src="../../uploads/avatars/userpic-petro.jpg" alt="Аватар пользователя">-->
<!--                            </div>-->
<!--                            <div class="post__info">-->
...
<!--                                <img src="../../uploads/photos/coast.jpg" alt="Превью к видео" width="760" height="396">-->
<!--                            </div>-->
...
<!--                        <a class="post__author-link" href="#" title="Автор">-->
<!--                            <div class="post__avatar-wrapper">-->
<!--                                <img class="post__author-avatar" src="../../uploads/avatars/userpic-mark.jpg" alt="Аватар пользователя">-->
<!--                            </div>-->
<!--                            <div class="post__info">-->
...
<!--                        <a class="post__author-link" href="#" title="Автор">-->
<!--                            <div class="post__avatar-wrapper">-->
<!--                                <img class="post__author-avatar" src="../../uploads/avatars/userpic-larisa.jpg" alt="Аватар пользователя">-->
<!--                            </div>-->
<!--                            <div class="post__info">-->
