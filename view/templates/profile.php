                ...
                <?= $subscribed ? ' button--quartz' : ''; ?>"
                    ...
                    <?php if ($subscribed): ?>
                        <a class="profile__user-button user__button user__button--writing button button--green"
                           href="/messages.php?<?= esc(http_build_query(['chat' => $profileId])) ?>">Сообщение
                        </a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
                ...
                <ul class="profile__tabs-list filters__list tabs__list">
                    <?php foreach ($profileTabs as $tab): ?>
                        <li class="profile__tabs-item filters__item">
                            <a class="profile__tabs-link filters__button<?= current(array_values($tab['href'])) === $activeTab ? ' filters__button--active tabs__item tabs__item--active' : ''; ?> button" href="<?= esc(getQueryString($queryString,
                                $tab['href'])); ?>"><?= esc($tab['title']) ?></a>
                        </li>
                    <?php endforeach; ?>
                </ul>
            </div>
                                ...
                                <li class="post-mini post user">
                                    <div class="post-mini__user-info user__info">
                                        ...
                                        <div class="post-mini__name-wrapper user__name-wrapper">
                                            ...
                                            <time class="post-mini__time user__additional" datetime="<?= esc($user['date']); ?>"><?= esc(getRelativeDateFormat($user['date'],
                                                    'на сайте')); ?></time>
                                        </div>
                                    </div>
                                    ...
                                    <?php if ($user['id'] !== $_SESSION['id']): ?>
                                        <div class="post-mini__user-buttons user__buttons">
                                            <a class="post-mini__user-button user__button user__button--subscription button button--main <?= $user['curr_subscribed'] ? ' button--quartz' : ''; ?>"
                                               href="/profile.php?<?= esc(http_build_query([
                                                   'id' => $user['id'],
                                                   'action' => $user['curr_subscribed'] ? 'unsubscribe' : 'subscribe'
                                               ])) ?>">
