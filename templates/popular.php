                ...
                <div class="post__main">
                    ...
                    <?php elseif ($post['type'] === 'photo'):  ?>
                        <div class="post-photo__image-wrapper">
                            <img src="<?= esc($post['img_path']); ?>" alt="Фото от пользователя" width="360" height="240">
                        </div>
                    ...
                    <div class="post__author">
                        <a class="post__author-link" href="#" title="Автор">
                            <div class="post__avatar-wrapper">
                                <img class="post__author-avatar" src="<?= esc($post['avatar']); ?>" alt="Аватар пользователя">
                            </div>
                            <div class="post__info">
                                <b class="post__author-name"><?= esc($post['author']); ?></b>
                                <time class="post__time" datetime="<?= esc($post['creation_date']); ?>" title="<?= esc(show_title_date_format($post['creation_date'])); ?>"><?= esc(get_relative_date_format($post['creation_date'])); ?></time>
                            </div>
                        </a>
                    </div>
